...
- `ai-assist`: fact repository for this codebase. Use `ai-assist/rules/` for conventions such as workflow naming, and `ai-assist/skills/` for reusable assistant skills.
...
- Check `ai-assist/` for codebase facts before inventing conventions: rules live in `ai-assist/rules/`, and skills live in `ai-assist/skills/`.
